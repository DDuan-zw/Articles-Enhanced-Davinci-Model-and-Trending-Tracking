...
# defining the DAG
with DAG(
    'medium_top_articles_dag',
    default_args=default_args,
    description='Get most popular articles from medium and upload embeddings to Ponecone, run only once.',
    ...
    # task pipeline 
    load2pinecone(processing_article.partial().expand(arti = get_hot_articles()))